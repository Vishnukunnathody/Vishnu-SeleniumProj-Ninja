...
public class TC_RF_24_verifyDFormSubmit_NoConfirmPass {
	...
	// Entering all the mandatory fields--> No confirm pass
	...
	public static void verifyConfirmPassErrorMsg() {
		String passErrMsg = driver
				.findElement(By.xpath("//div[contains(text(),'Password confirmation does not match password!')]"))
				.getText();

		if (passErrMsg.equals(passErrMsg)) {
